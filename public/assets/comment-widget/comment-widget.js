...
const s_stylePath = '/assets/comment-widget/comment-widget.css';
const s_formId = '1FAIpQLSe8rbGGriNfL-qi00r_lOfvOclxiQuK7o8iQBInDT1CT4HKUw';
const s_nameId = '292784647';
const s_websiteId = '1751352904';
const s_textId = '1081305732';
const s_pageId = '1058695394';
const s_replyId = '83591638';
const s_moderatedId = '831444992';
const s_adminId = '1999678388';
const s_sheetId = '1QrIUCRCHALgbFQFb5R9KFavm1G695E2NBp4sWnYRw0Q';
...
const s_commentsPerPage = 12; // The max amount of comments that can be displayed on one page, any number >= 1 (Replies not counted)
...
const s_noCommentsText = 'you feel a black wind blow through you... \n(no comments here just yet!)';
const s_closedCommentsText = 'comments currently closed, sorry!';
...
if (v_pagePath.endsWith(".html")) { v_pagePath = v_pagePath.replace(".html", ""); }
...
function createComment(data) {
    ...
    if(data.Moderated == false) {
        text.innerText = '(this comment is awaiting approval!)';
    }
...
function convertTimestamp(timestamp) {
    ...
    return [offsetDate.toLocaleString("en-US", { dateStyle: "medium", timeStyle: "short" }), offsetDate.toLocaleDateString()];
}
// DST checker
function isDST(date) {
